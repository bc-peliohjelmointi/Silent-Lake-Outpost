	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uvMaterial_Texture2D_2 = packedInput.ase_texcoord5.xy * Material_Texture2D_2_ST.xy + Material_Texture2D_2_ST.zw;
				
				float2 uvMaterial_Texture2D_3 = packedInput.ase_texcoord5.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				
				surfaceDescription.BaseColor = desaturateVar31;
				surfaceDescription.Normal = appendResult15.xyz;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2D( Material_Texture2D_2, uvMaterial_Texture2D_2 ).r;
				...
				surfaceDescription.Smoothness = ( ( 1.0 - tex2D( Material_Texture2D_3, uvMaterial_Texture2D_3 ).r ) * _Roughness );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uvMaterial_Texture2D_2 = packedInput.ase_texcoord2.xy * Material_Texture2D_2_ST.xy + Material_Texture2D_2_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uvMaterial_Texture2D_2 = packedInput.ase_texcoord7.xy * Material_Texture2D_2_ST.xy + Material_Texture2D_2_ST.zw;
...
Node;AmplifyShaderEditor.SamplerNode;2;-1606.801,-19.90009;Inherit;True;Property;Material_Texture2D_0;Normal;1;0;Create;False;0;0;0;False;0;False;-1;abc00000000005546889098118452484;abc00000000005546889098118452484;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;46;4;10;1
WireConnection;46;7;8;0
ASEEND*/
//CHKSM=F6A2D2A7F2242C65770AD958FF1C561C66C83364