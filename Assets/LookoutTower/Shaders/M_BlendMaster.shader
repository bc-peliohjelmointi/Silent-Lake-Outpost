	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_34_0 = ( packedInput.ase_color.g + ( packedInput.ase_color.g * tex2D( _T_VertexBlend_Mask, ( texCoord23 * _VColor_G_Scale ) ).r ) );
...
ASEEND*/
//CHKSM=98181753FC8BE22841BDB43F3911B33534C61CAD