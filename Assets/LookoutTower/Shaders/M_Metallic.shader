...
Shader "M_Metallic"
{
	Properties
	{
		...
		_AlbedoColor("AlbedoColor", Range( 0 , 5)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 temp_cast_0 = (_AlbedoColor).xxxx;
				float2 texCoord27 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.BaseColor = ( _AlbedoColor * staticSwitch16 ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( Material_Texture2D_0, temp_output_29_0 ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = staticSwitch30;
				...
				surfaceDescription.Smoothness = staticSwitch25;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord27 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_29_0 = ( texCoord27 * _UV );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float4 temp_cast_0 = (_AlbedoColor).xxxx;
				float2 texCoord27 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_29_0 = ( texCoord27 * _UV );
				float4 tex2DNode11 = tex2D( Material_Texture2D_1, temp_output_29_0 );
				#ifdef _USECOLOR_ON
				float4 staticSwitch15 = ( _Color * tex2DNode11 );
...
Node;AmplifyShaderEditor.SamplerNode;11;-1867.526,-295.7316;Inherit;True;Property;Material_Texture2D_1;Albedo;0;0;Create;False;0;0;0;False;0;False;-1;abc00000000011835080966170663043;abc00000000003652513706357481624;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;22;-1204.934,534.6415;Inherit;True;Property;Material_Texture2D_0;Normal;1;0;Create;False;0;0;0;False;0;False;-1;abc00000000016124000965088101700;abc00000000010912314784129947894;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;32;7;25;0
ASEEND*/
//CHKSM=4F2F899523788288A54C80E3BC2DE941140C721B