	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uvMaterial_Texture2D_1 = packedInput.ase_texcoord5.xy * Material_Texture2D_1_ST.xy + Material_Texture2D_1_ST.zw;
				float4 tex2DNode2 = tex2D( Material_Texture2D_1, uvMaterial_Texture2D_1 );
				
				float2 uvMaterial_Texture2D_0 = packedInput.ase_texcoord5.xy * Material_Texture2D_0_ST.xy + Material_Texture2D_0_ST.zw;
				...
				float2 uvMaterial_TextureD_2 = packedInput.ase_texcoord5.xy * Material_TextureD_2_ST.xy + Material_TextureD_2_ST.zw;
				
				float2 uvMaterial_Texture2D_3 = packedInput.ase_texcoord5.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				...
				surfaceDescription.BaseColor = ( tex2DNode2 * _Brightness ).rgb;
				surfaceDescription.Normal = appendResult13.xyz;
				...
				surfaceDescription.Smoothness = ( ( 1.0 - tex2D( Material_TextureD_2, uvMaterial_TextureD_2 ).r ) * _Roughness );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uvMaterial_Texture2D_1 = packedInput.ase_texcoord2.xy * Material_Texture2D_1_ST.xy + Material_Texture2D_1_ST.zw;
				float4 tex2DNode2 = tex2D( Material_Texture2D_1, uvMaterial_Texture2D_1 );
				
				float2 uvMaterial_Texture2D_0 = packedInput.ase_texcoord2.xy * Material_Texture2D_0_ST.xy + Material_Texture2D_0_ST.zw;
				float3 break10 = UnpackNormalScale( tex2D( Material_Texture2D_0, uvMaterial_Texture2D_0 ), 1.0f );
				float4 appendResult13 = (float4(break10.x , ( break10.y * _Invert ) , break10.z , 0.0));
				
				float2 uvMaterial_TextureD_2 = packedInput.ase_texcoord2.xy * Material_TextureD_2_ST.xy + Material_TextureD_2_ST.zw;
				
				float2 uvMaterial_Texture2D_3 = packedInput.ase_texcoord2.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				float4 temp_cast_2 = (tex2DNode2.a).xxxx;
				#ifdef _USEALBEDOALPHA_ON
				float4 staticSwitch14 = temp_cast_2;
				#else
		...
		Pass
		{
					...
					)
			{
				...
				float2 uvMaterial_Texture2D_3 = packedInput.ase_texcoord1.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				float2 uvMaterial_Texture2D_1 = packedInput.ase_texcoord1.xy * Material_Texture2D_1_ST.xy + Material_Texture2D_1_ST.zw;
				float4 tex2DNode2 = tex2D( Material_Texture2D_1, uvMaterial_Texture2D_1 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uvMaterial_Texture2D_0 = packedInput.ase_texcoord3.xy * Material_Texture2D_0_ST.xy + Material_Texture2D_0_ST.zw;
				float3 break10 = UnpackNormalScale( tex2D( Material_Texture2D_0, uvMaterial_Texture2D_0 ), 1.0f );
				float4 appendResult13 = (float4(break10.x , ( break10.y * _Invert ) , break10.z , 0.0));
				
				float2 uvMaterial_TextureD_2 = packedInput.ase_texcoord3.xy * Material_TextureD_2_ST.xy + Material_TextureD_2_ST.zw;
				
				float2 uvMaterial_Texture2D_3 = packedInput.ase_texcoord3.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				float2 uvMaterial_Texture2D_1 = packedInput.ase_texcoord3.xy * Material_Texture2D_1_ST.xy + Material_Texture2D_1_ST.zw;
				float4 tex2DNode2 = tex2D( Material_Texture2D_1, uvMaterial_Texture2D_1 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uvMaterial_Texture2D_1 = packedInput.ase_texcoord7.xy * Material_Texture2D_1_ST.xy + Material_Texture2D_1_ST.zw;
				float4 tex2DNode2 = tex2D( Material_Texture2D_1, uvMaterial_Texture2D_1 );
				
				float2 uvMaterial_Texture2D_0 = packedInput.ase_texcoord7.xy * Material_Texture2D_0_ST.xy + Material_Texture2D_0_ST.zw;
				float3 break10 = UnpackNormalScale( tex2D( Material_Texture2D_0, uvMaterial_Texture2D_0 ), 1.0f );
				float4 appendResult13 = (float4(break10.x , ( break10.y * _Invert ) , break10.z , 0.0));
				
				float2 uvMaterial_TextureD_2 = packedInput.ase_texcoord7.xy * Material_TextureD_2_ST.xy + Material_TextureD_2_ST.zw;
				
				float2 uvMaterial_Texture2D_3 = packedInput.ase_texcoord7.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				float4 temp_cast_2 = (tex2DNode2.a).xxxx;
				#ifdef _USEALBEDOALPHA_ON
				float4 staticSwitch14 = temp_cast_2;
				#else
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.SamplerNode;9;-1077.424,-30.60984;Inherit;True;Property;Material_Texture2D_0;Normal;2;0;Create;False;0;0;0;False;0;False;-1;abc00000000005546889098118452484;abc00000000011614168181355928235;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-783.0624,-165.8431;Inherit;False;Property;_Invert;Invert;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-536.8902,-356.8895;Inherit;False;Property;_Brightness;Brightness;4;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-1626.082,-584.0287;Inherit;True;Property;Material_Texture2D_1;Albedo;0;0;Create;False;0;0;0;False;0;False;-1;abc00000000013474387870728954763;abc00000000005219264639637305418;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;4;-1476.732,289.3799;Inherit;True;Property;Material_Texture2D_3;Mask;1;0;Create;False;0;0;0;False;0;False;-1;abc00000000013474387870728954763;abc00000000003492334217075298265;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;28;7;7;0
WireConnection;28;9;14;0
ASEEND*/
//CHKSM=AB25EC36030FB999FCC1EE9081B4F9E66AB05F3B